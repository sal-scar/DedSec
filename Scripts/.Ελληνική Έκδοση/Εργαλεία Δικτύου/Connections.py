...
def start_cloudflared_tunnel(port, proto="http", name=""):
    ...
    try:
        ...
        print(f"❌ Αποτυχία εκκίνησης Cloudflare tunnel για {name}: {e}")
        return None, None
...
<body>
<div class="topbar">
  <a class="back-btn" href="/">← Επιστροφή στο Connections</a>
</div>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div class="title-wrap">
                ...
                <div class="subtitle" id="statusText">Ασφαλές • Έτοιμο</div>
            </div>
        </div>
...
function initializeChat(secretKey) {
    ...
    const updateViewButtons = () => {
        if (allCamsBtn) {
            ...
            if (lbl) lbl.textContent = gridOverlay ? 'Επικάλυψη' : 'Όλες';
        }
        if (hideCamBtn) {
            ...
            if (lbl) lbl.textContent = hideCameras ? 'Εμφάνιση' : 'Απόκρυψη';
        }
